			...
			>
				<div className='item'>
					<div className='bg-primary-soft rounded text-center p-5'>
						<div className='mb-3'>
							<img
								className='img-fluid rounded-top d-inline'
								src={require(`/assets/images/team/01.png`)}
								alt=''
							/>
						</div>
						<div>
				...
				<div className='item'>
					<div className='bg-primary-soft rounded text-center p-5'>
						<div className='mb-3'>
							<img
								className='img-fluid rounded-top d-inline'
								src={require(`/assets/images/team/02.png`)}
								alt=''
							/>
						</div>
						<div>
				...
				<div className='item'>
					<div className='bg-primary-soft rounded text-center p-5'>
						<div className='mb-3'>
							<img
								className='img-fluid rounded-top d-inline'
								src={require(`/assets/images/team/03.png`)}
								alt=''
							/>
						</div>
						<div>

...
class Services extends Component {
	render() {
		return (
			<section
				className='custom-pt-1 custom-pb-2 bg-dark position-relative'
				data-bg-img={require(`/assets/images/bg/02.png`)}
			>
							...
							<div className='bg-primary-soft rounded p-5'>
								<div className='d-flex align-items-center mb-4'>
									<div className='mr-3'>
										<img
											className='img-fluid'
											src={require(`/assets/images/icon/01.svg`)}
											alt=''
										/>
									</div>
							...
							<div className='bg-primary-soft rounded p-5'>
								<div className='d-flex align-items-center mb-4'>
									<div className='mr-3'>
										<img
											className='img-fluid'
											src={require(`/assets/images/icon/02.svg`)}
											alt=''
										/>
									</div>
							...
							<div className='bg-primary-soft rounded p-5'>
								<div className='d-flex align-items-center mb-4'>
									<div className='mr-3'>
										<img
											className='img-fluid'
											src={require(`/assets/images/icon/03.svg`)}
											alt=''
										/>
									</div>
							...
							<div className='bg-primary-soft rounded p-5'>
								<div className='d-flex align-items-center mb-4'>
									<div className='mr-3'>
										<img
											className='img-fluid'
											src={require(`/assets/images/icon/04.svg`)}
											alt=''
										/>
									</div>
							...
							<div className='bg-primary-soft rounded p-5'>
								<div className='d-flex align-items-center mb-4'>
									<div className='mr-3'>
										<img
											className='img-fluid'
											src={require(`/assets/images/icon/05.svg`)}
											alt=''
										/>
									</div>

		...
		return (
			<div className='row align-items-center'>
				<div className='col-12 col-lg-5 col-xl-6 order-lg-2 mb-8 mb-lg-0'>
					{/* Image */}
					<img
						src={require(`/assets/images/hero/05.png`)}
						className='img-fluid'
						alt='...'
					/>
				</div>
				<div className='col-12 col-lg-7 col-xl-6 order-lg-1'>
					...
					{/* Buttons */}
					<Link to='/' className='btn btn-primary text-white text-left mr-1'>
						{' '}
						<i className='la la-apple mr-2 ic-2x d-inline-block' />
					...
					<Link to='/' className='btn btn-dark text-white text-left'>
						{' '}
						<i className='la la-android mr-2 ic-2x d-inline-block' />
						<div className='d-inline-block'>
							{' '}

				...
				<div className='container'>
					<div className='row align-items-center'>
						<div className='col-lg-5 col-12 order-lg-1 mb-8 mb-lg-0'>
							<img
								src={require(`/assets/images/about/08.png`)}
								alt='Image'
								className='img-fluid'
							/>
						</div>
						<div className='col-lg-7 col-12'>
							...
							<div className='row'>
								<div className='col-lg-6 col-md-6'>
									<div className='d-flex align-items-start'>
										...
										<div>
											<h5>Live Chat</h5>
											<p className='mb-0'>
												Serspiciatis unde omnis iste natus laudantium.
											</p>
										</div>
									</div>
								</div>
								<div className='col-lg-6 col-md-6 mt-6 mt-md-0'>
									<div className='d-flex align-items-start'>
										<div>
											<div className='f-icon-shape-sm text-white bg-dark rounded-circle shadow-primary mr-3'>
												{' '}
								...
								<div className='col-lg-6 col-md-6 mt-6'>
									<div className='d-flex align-items-start'>
										<div>
											<div className='f-icon-shape-sm text-white bg-white rounded-circle shadow-primary mr-3'>
												{' '}
												<i className='la la-download ic-2x text-primary' />
											</div>
										</div>
										<div>
											<h5>Free Update</h5>
								...
								<div className='col-lg-6 col-md-6 mt-6'>
									<div className='d-flex align-items-start'>
										<div>
											<div className='f-icon-shape-sm text-white bg-orange rounded-circle shadow-primary mr-3'>
												{' '}

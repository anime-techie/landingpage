			...
			<div className='product-item product-list mb-5'>
				<div className='row align-items-center'>
					<div className='col-lg-4 col-md-5'>
						<Link
							to={`/product-single/${productdata.category}/${productdata.id}`}
						>
							<div className='product-img'>
								<img
									className='img-fluid'
									src={require(`/assets/images/${productdata.pictures[0]}`)}
									alt=''
								/>
							</div>
						</Link>
					...
					<div className='col-lg-8 col-md-7'>
						<div className='product-desc'>
							...
							<p className='mb-0 mt-2'>{productdata.description}</p>
							<div className='product-link mt-3'>
								{!this.CartItems(productdata.id) ? (
									<Link
										...
										rel='nofollow'
									>
										<i className='ti-bag mr-2' />
										Add to cart
									</Link>
								) : (
									<Link to='/cart' className='add-cart' rel='nofollow'>
										<i className='ti-bag mr-2' />
										View Cart
									</Link>
								)}

				...
				<div className='row mt-8'>
					<div className='col-12 col-lg-6 mb-6 mb-lg-0'>
						...
						<div className='card border-0 bg-transparent'>
							...
							<img
								...
								src={require(`/assets/images/blog/01.png`)}
								alt='Image'
							/>
							<div className='card-body pt-5'>
								...
								<p>
									Businesses need access to development resources serspiciatis
								...
								<ul className='list-inline mb-0'>
									<li className='list-inline-item pr-4'>
										...
										<Link to='/' className='text-muted'>
											<i className='ti-comments mr-1 text-primary' /> 131
										</Link>
									</li>
									<li className='list-inline-item pr-4'>
										{' '}
										<Link to='/' className='text-muted'>
											<i className='ti-eye mr-1 text-primary' /> 255
										</Link>
									</li>
									<li className='list-inline-item'>
										{' '}
										<Link to='/' className='text-muted'>
											<i className='ti-comments mr-1 text-primary' /> 14
										</Link>
									</li>
								</ul>
							</div>
					...
					<div className='col-12 col-lg-6'>
						...
						<div className='card border-0 bg-transparent'>
							...
							<img
								className='card-img-top shadow rounded'
								src={require(`/assets/images/blog/02.png`)}
								alt='Image'
							/>
							<div className='card-body pt-5'>
								{' '}
						...
						<nav aria-label='...'>
							<ul className='pagination'>
								...
								<li className='page-item'>
									<Link className='page-link border-0 rounded text-dark' to='/'>
										1
									</Link>
								</li>
								<li className='page-item active' aria-current='page'>
									{' '}
									<Link className='page-link border-0 rounded' to='/'>
